...
exports.keyRevoke = (network, vaultPath, keyIdToRevoke, didFromRevoke, signerKeyId, gasPassphrase) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    const lastTxId = yield layer2Api.getLastTxId(didFromRevoke);
