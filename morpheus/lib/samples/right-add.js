...
exports.rightAdd = (network, vaultPath, keyIdToAdd, didToAdd, signerKeyId, gasPassphrase) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    const opAttempts = new sdk_1.Layer1.OperationAttemptsBuilder()
        ...
        .addRight(keyIdToAdd, new sdk_1.Layer2.SystemRights().impersonate)
        .sign(signerKeyId)
        .getAttempts();
