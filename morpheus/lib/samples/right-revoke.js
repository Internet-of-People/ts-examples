...
exports.rightRevoke = (network, vaultPath, keyIdToRevoke, didToAdd, signerKeyId, gasPassphrase) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    const opAttempts = new sdk_1.Layer1.OperationAttemptsBuilder()
        ...
        .revokeRight(keyIdToRevoke, new sdk_1.Layer2.SystemRights().impersonate)
        .sign(signerKeyId)
        .getAttempts();
