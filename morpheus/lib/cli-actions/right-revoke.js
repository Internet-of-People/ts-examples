...
const right_revoke_1 = require("../samples/right-revoke");
class RightRevokeAction extends ts_command_line_1.CommandLineAction {
    constructor() {
        super({
    ...
    onExecute() {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            yield right_revoke_1.rightRevoke(this.network.value, this.vaultPath.value, sdk_1.Crypto.authenticationFromData(this.keyIdToAdd.value), new sdk_1.Crypto.Did(this.onDid.value), sdk_1.Crypto.authenticationFromData(this.signerKeyId.value), this.gasPassphrase.value);
        });
    }
}
exports.RightRevokeAction = RightRevokeAction;
//# sourceMappingURL=right-revoke.js.map