...
class RightRevokeAction extends ts_command_line_1.CommandLineAction {
    ...
    onExecute() {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            yield right_revoke_1.rightRevoke(this._vaultPath.value, sdk_1.Crypto.authenticationFromData(this._keyIdToAdd.value), new sdk_1.Crypto.Did(this._onDid.value), sdk_1.Crypto.authenticationFromData(this._signerKeyId.value), this._gasPassphrase.value);
        });
    }
}
