...
class RightRevokeAction extends ts_command_line_1.CommandLineAction {
    ...
    onExecute() {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            yield right_revoke_1.rightRevoke(this.vaultPath.value, sdk_1.Crypto.authenticationFromData(this.keyIdToAdd.value), new sdk_1.Crypto.Did(this.onDid.value), sdk_1.Crypto.authenticationFromData(this.signerKeyId.value), this.gasPassphrase.value);
        });
    }
}
