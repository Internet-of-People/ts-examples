...
exports.sendUpdate = (domain, data) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    const noncedOps = new sdk_wasm_1.NoncedOperationsBuilder()
        .add(sdk_wasm_1.UserOperation.update(new sdk_wasm_1.DomainName(domain), JSON.parse(data)))
